...
final class EffectEngineTest {
    ...
    void skipsActionWhenChanceFails() {
        ...
        EffectEngine engine = new EffectEngine(type -> Optional.of(context -> executed.add(type)), () -> 0.99);
    ...
    void executesConfiguredActionsWhenChancePasses() {
        List<String> executed = new ArrayList<>();
        EffectEngine engine = new EffectEngine(type -> Optional.of(context -> executed.add(type)), () -> 0.0);
    ...
    void skipsUnknownActionSafely() {
        ...
        EffectEngine engine = new EffectEngine(type -> "known".equals(type)
                ? Optional.of(context -> executed.add(type))
                : Optional.empty(), () -> 0.0);
